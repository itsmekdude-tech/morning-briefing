...
export const realApi = {
  ...
  async getAuthStart(): Promise<{ authorization_url: string }> {
    return fetchJson(url('/api/auth/start'));
  },

  async getMode(): Promise<{ inbox_source: 'mock' | 'gmail' }> {
    return fetchJson(url('/api/briefing/mode'));
  },
